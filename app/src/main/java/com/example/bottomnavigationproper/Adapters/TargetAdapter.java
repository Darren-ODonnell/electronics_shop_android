...
public class TargetAdapter extends RecyclerView.Adapter<TargetAdapter.ViewHolder> implements ItemTouchHelperAdapter {
    private List<String> items;

    public TargetAdapter(List<String> items) {
        this.items = items;
    }
